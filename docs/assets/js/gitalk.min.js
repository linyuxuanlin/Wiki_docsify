    ...
    return function (e) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            function (e) {
                ...
                function C(e) {
                    ...
                    return e = _({
                        constructor: t
                    }, e), e.mixins && O(e, N(e.mixins)), e.statics && _(t, e.statics), e.propTypes && (t.propTypes = e.propTypes), e.defaultProps && (t.defaultProps = e.defaultProps), e.getDefaultProps && (t.defaultProps = e.getDefaultProps()), S.prototype = I.prototype, t.prototype = _(new S, e), t.displayName = e.displayName || "Component", t
                }
                ...
                var B = "15.1.0",
                    ...
                    W = {},
                    Y = void 0 === e || !e.env || "production" !== e.env.NODE_ENV,
                    q = G.h("a", null).constructor;
        ...
        e.exports = function (e, t, n, h, m, v, g) {
            ...
            if (T && (w = l(T.call(new e))) !== Object.prototype && w.next && (c(w, x, !0), r || "function" == typeof w[f] || a(w, f, d)), E && N && "values" !== N.name && (S = !0, O = function () {
                    return N.call(this)
                }), r && !g || !p && !S && C[f] || a(C, f, O), u[t] = O, u[x] = d, m)
                if (y = {
                        values: E ? O : _("values"),
                        keys: v ? O : _("keys"),
                        entries: k
            ...
            e.exports = function (e) {
                return new Promise(function (l, f) {
                    ...
                    var h = new XMLHttpRequest,
                        ...
                        v = !1;
                    if ("test" === t.env.NODE_ENV || "undefined" == typeof window || !window.XDomainRequest || "withCredentials" in h || u(e.url) || (h = new window.XDomainRequest, m = "onload", v = !0, h.onprogress = function () {}, h.ontimeout = function () {}), e.auth) {
            ...
            d = function () {
                ...
                return (0, u.default)(e, [{
                    ...
                    value: function (e) {
                        ...
                        else if (!(t = window.document.getElementById(e))) throw new Error("Container not found, window.document.getElementById: " + e);
                        return (0, l.render)(c.default.createElement(p.default, {
        ...
        */
        ...
        ! function () {
            ...
            function n(e, n) {
                ...
                for (n && null != n.children && (P.length || P.push(n.children), delete n.children); P.length;)
                    if ((o = P.pop()) && void 0 !== o.pop)
                        for (a = o.length; a--;) P.push(o[a]);
            ...
            function y(e, t, n, r, o) {
                ...
                if (0 !== v)
                    for (var _ = 0; _ < v; _++) {
                        var x = l[_],
                            E = x.__preactattr_,
                            S = w && E ? x._component ? x._component.__k : E.key : null;
                ...
                if (0 !== w)
                    for (var _ = 0; _ < w; _++) {
                        s = t[_], c = null;
                        var S = s.key;
                        if (null != S) h && void 0 !== d[S] && (c = d[S], d[S] = void 0, h--);
                        else if (!c && m < y)
                            for (i = m; i < y; i++)
            ...
            function E(e, t, n) {
                var r, o = B[e.name];
                if (e.prototype && e.prototype.render ? (r = new e(t, n), T.call(r, t, n)) : (r = new T(t, n), r.constructor = e, r.render = S), o)
            ...
            function N(e, t, n, o) {
                if (!e.__x) {
                    ...
                    if (!g || n ? L.unshift(e) : x || (m(), e.componentDidUpdate && e.componentDidUpdate(p, d, h), M.afterUpdate && M.afterUpdate(e)), null != e.__h)
                ...
                return (0, g.default)(t, e), (0, d.default)(t, [{
                    ...
                    value: function () {
                        ...
                        return b.default.createElement("div", {
                            ...
                            className: "gt-popup"
                        }, t ? b.default.createElement(P.default, {
        ...
        var r, o, i, a, u = n(20),
            ...
            L = function (e) {
                g.call(s, function () {
                    var t;
                    k ? S.emit("rejectionHandled", e) : (t = s.onrejectionhandled) && t({
                        promise: e,
                        reason: e._v
                    })
                })
        ...
        M || (O = function (e) {
            ...
            Promise: O
        }), n(26)(O, "Promise"), n(111)("Promise"), a = n(0).Promise, f(f.S + f.F * !M, "Promise", {
            reject: function (e) {
                var t = A(this);
        ...
        e.exports = !s || n(14)(function () {
            ...
            for (var n = a(e), s = arguments.length, c = 1, l = o.f, f = i.f; s > c;)
                for (var p, d = u(arguments[c++]), h = l ? r(d).concat(l(d)) : r(d), m = h.length, v = 0; m > v;) f.call(d, p = h[v++]) && (n[p] = d[p]);
            return n
        } : s
    }, function (e, t, n) {
        ...
        var r = n(1),
            ...
            Y = function (e, t, n) {
                return e === B && Y(G, t, n), y(e), t = _(t, !0), y(n), o(F, t) ? (n.enumerable ? (o(e, D) && e[D][t] && (e[D][t] = !1), n = E(n, {
                    enumerable: x(0, !1)
                })) : (o(e, D) || T(e, D, x(1, {})), e[D][t] = !0), X(e, t, n)) : T(e, t, n)
            },
            q = function (e, t) {
                y(e);
        ...
        */
        ...
        r.prototype.request = function (e) {
            "string" == typeof e && (e = i.merge({
                ...
                method: "get"
            }, e), e.method = e.method.toLowerCase(), e.baseURL && !s(e.url) && (e.url = c(e.baseURL, e.url));
            var t = [u, void 0],
                n = Promise.resolve(e);
            ...
            return (0, d.default)(t, e), (0, c.default)(t, [{
                ...
                value: function () {
                    var e = this.props,
                        ...
                        f = ~[].concat(u).map(function (e) {
                            return e.toLowerCase()
                        }).indexOf(t.user.login.toLowerCase()),
                        p = t.reactions,
                        d = "";
                    return p && p.totalCount && (d = p.totalCount, 100 === p.totalCount && p.pageInfo && p.pageInfo.hasNextPage && (d = "100+")), m.default.createElement("div", {
                    ...
                    }, t.user && t.user.login), m.default.createElement("span", {
                        className: "gt-comment-text"
                    }, i), m.default.createElement("span", {
                        className: "gt-comment-date"
                    }, (0, _.default)(t.created_at, {
                        addSuffix: !0,
                        locale: {
                            distanceInWords: window.GT_i18n_distanceInWordsLocaleMap[r]
                        }
        ...
        o(o.S + o.F * !n(63)(function (e) {
            ...
            from: function (e) {
                var t, n, o, f, p = i(e),
                    ...
                    g = 0,
                    y = l(p);
                if (v && (m = r(m, h > 2 ? arguments[2] : void 0, 2)), void 0 == y || d == Array && u(y))
                    for (t = s(p.length), n = new d(t); t > g; g++) c(n, g, v ? m(p[g], g) : p[g]);
                else
                    for (f = y.call(p), n = new d; !(o = f.next()).done; g++) c(n, g, v ? a(f, m, [o.value, g], !0) : o.value);
                return n.length = g, n
            }
        })
    }, function (e, t, n) {
